  ...
  <div >
    <div>
                ...
                <b-card
                      ...
                      class="mb-2 container Urun row"
                
                    >
                    <div class="image-sepet">
                        <img :src="productItem1.resim" class="image" alt="">

                        <div class="middle">
                          <button class="sepetbuton"   @click="addCartItem(productItem1)" href="//PikapIgnesiVeKristali" v-on:click="say('Sepete Eklendi')">Sepete Ekle</button>
                        </div>
                        </div>
                        <b-card-text style="font-size:13px;">           
                          {{productItem1.title}}        
                     </b-card-text>
                        <span class="image1f"> {{productItem1.price}} TL</span>                    
                    </b-card>
